...
<template>
  <header class="h-14 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 flex items-center justify-between shrink-0">
    <!-- Left: Logo and Title -->
    <div class="flex items-center gap-3">
      <img src="/FormGear.png" alt="FormGear" class="w-8 h-8" />
      <div>
    ...
    <div class="flex items-center gap-2">
      ...
      <div class="relative group">
        <button class="px-3 py-1.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md flex items-center gap-1.5">
      ...
      <button
        @click="clearForm"
        class="px-3 py-1.5 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md flex items-center gap-1.5"
      >
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
