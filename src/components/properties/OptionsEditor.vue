...
<template>
  <div class="p-3">
    ...
    <Dialog :open="showAPIConfig" @update:open="(open: boolean) => !open && closeAPIConfig()">
      <DialogContent class="sm:max-w-lg max-h-[80vh] flex flex-col p-0 gap-0">
        <DialogHeader class="p-4 pb-0">
          <DialogTitle>Configure API Source</DialogTitle>
          <DialogDescription>
            Set up an API endpoint to fetch options dynamically.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter class="p-4 border-t border-gray-200 dark:border-gray-700">
          <Button variant="outline" @click="closeAPIConfig">
            Cancel
          </Button>
          <Button
            @click="saveAPIConfig"
